...
1. Create Groups (must be an 'official' group type)
   ...
   1. TIL Users (can view / open only)
      ...
      - Expected permissions for group members
        1. architect:datatable:view
        1. architect:datatableRow:view
        1. analytics:conversationDetail:view
        1. recording:recording:view
        1. speechAndTextAnalytics:data:view

   1. TIL Library Admins (can edit interactions in library and perform management tasks)

      - Expected permissions for group members
        1. architect:datatableRow:add
        1. architect:datatableRow:edit
        1. architect:datatableRow:delete

   1. TIL Integration Admins
      - Expected permissions for group members
        1. architect:datatable:add
        1. architect:datatable:edit
        1. integrations:integration:view
        1. ntegrations:integration:edit
...
1. Configure Integration
   1. URL
      - Syntax = <url>?<gc_region>&<gc_client>&<gc_integration>[&<gc_datatable>]&<til_library_admins_group>[&<til_integration_admins_group> : <til_integration_admins_ids>]
      ...
      - til_integration_admins_group = Group ID for users that can perform updates to datatable and integration from within app
...
1. Update delete functionality to remove DOM tables correctly
